...
function App() {
  ...
  return (
    <div className="w-full h-full flex flex-row gap-8" style={{
      height: "100vh"
    }}>
      <div className="flex flex-col justify-start items-center py-20 px-10 gap-8">
        ...
        {step === 3 && isNewTab && (
          <>
            <Blockquote>
              Successfully got the data. Showing sample data 1 row and 10
              columns.
            </Blockquote>
            <Table.Root>
              <Table.Header>
      ...
      <div className="w-full border-1 border-left p-10" style={{
